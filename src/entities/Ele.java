...
public class Ele extends Tetrimino{
	...
	public List<Bloque> getBloquesParaRotar() {
		...
		switch(angulo) {
			case 0 : 	lista.add(miGrilla.getBloque(pivote.getPosX()+1, pivote.getPosY()-1));
						...
						lista.add(miGrilla.getBloque(pivote.getPosX()-2, pivote.getPosY()));
						break;
			case 90:	lista.add(miGrilla.getBloque(pivote.getPosX()-1, pivote.getPosY()+1));
						lista.add(miGrilla.getBloque(pivote.getPosX()+1, pivote.getPosY()-1));
						lista.add(miGrilla.getBloque(pivote.getPosX(), pivote.getPosY()-2));
						break;
	...
	public void rotar() {
		switch(angulo) {
			case 0 :    A = moverBloqueAPos(A, pivote.getPosX()+1, pivote.getPosY()-1);
						B = moverBloqueAPos(B, pivote.getPosX()-1, pivote.getPosY()-1);
						C = moverBloqueAPos(C, pivote.getPosX()-2, pivote.getPosY());
						angulo = 90;
						break;
			case 90:	A = moverBloqueAPos(A, pivote.getPosX()-1, pivote.getPosY()+1);
						B = moverBloqueAPos(B, pivote.getPosX()+1, pivote.getPosY()-1);
						C = moverBloqueAPos(C, pivote.getPosX(), pivote.getPosY()-2);
						angulo = 180;
						break;
			case 180:	A = moverBloqueAPos(A, pivote.getPosX()-1, pivote.getPosY()-1);
						B = moverBloqueAPos(B, pivote.getPosX()+1, pivote.getPosY()+1);
						C = moverBloqueAPos(C, pivote.getPosX()+2, pivote.getPosY());
						angulo = 270;
						break;
			case 270:	A = moverBloqueAPos(A, pivote.getPosX()+1, pivote.getPosY()-1);
						B = moverBloqueAPos(B, pivote.getPosX()-1, pivote.getPosY()-1);
						C = moverBloqueAPos(C, pivote.getPosX(), pivote.getPosY()+2);
						angulo = 0;
						break;			
